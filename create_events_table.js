...
var con = mysql.createConnection({
    ...
    user: "C4131F21U87",         // replace with the database user provided to you
    password: "7599",     // replace with the database password provided to you
    database: "C4131F21U87",     // replace with the database user provided to you
    port: 3306
});
